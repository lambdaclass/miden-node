...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + core::marker::Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::Proof>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
...
pub mod proxy_status_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + core::marker::Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::ProxyStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
...
pub mod worker_status_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + core::marker::Send,
    {
        ...
        pub async fn status(
            &mut self,
            request: impl tonic::IntoRequest<()>,
        ) -> core::result::Result<tonic::Response<super::WorkerStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
