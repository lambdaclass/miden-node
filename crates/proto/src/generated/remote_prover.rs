...
pub struct ProxyStatus {
    ...
    pub workers: ::prost::alloc::vec::Vec<ProxyWorkerStatus>,
}
...
pub mod api_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.Api/Prove" => {
                    #[allow(non_camel_case_types)]
                    struct ProveSvc<T: Api>(pub Arc<T>);
                    impl<T: Api> tonic::server::UnaryService<super::ProofRequest>
                    for ProveSvc<T> {
    ...
    pub const SERVICE_NAME: &str = "remote_prover.Api";
...
pub mod proxy_status_api_client {
    ...
    impl ProxyStatusApiClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::ProxyStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
...
/// Generated server implementations.
pub mod proxy_status_api_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ProxyStatusApiServer.
    #[async_trait]
    pub trait ProxyStatusApi: std::marker::Send + std::marker::Sync + 'static {
        /// Returns the status of the proxy.
        async fn status(
            &self,
    ...
    #[derive(Debug)]
    pub struct ProxyStatusApiServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ProxyStatusApiServer<T>
    where
        T: ProxyStatusApi,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.ProxyStatusApi/Status" => {
                    #[allow(non_camel_case_types)]
                    struct StatusSvc<T: ProxyStatusApi>(pub Arc<T>);
                    impl<T: ProxyStatusApi> tonic::server::UnaryService<()>
                    for StatusSvc<T> {
                        type Response = super::ProxyStatus;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProxyStatusApi>::status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ProxyStatusApiServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "remote_prover.ProxyStatusApi";
    impl<T> tonic::server::NamedService for ProxyStatusApiServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod worker_status_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            &mut self,
            request: impl tonic::IntoRequest<()>,
        ) -> std::result::Result<tonic::Response<super::WorkerStatus>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.WorkerStatusApi/Status" => {
                    ...
                    impl<T: WorkerStatusApi> tonic::server::UnaryService<()>
                    for StatusSvc<T> {
                        type Response = super::WorkerStatus;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
