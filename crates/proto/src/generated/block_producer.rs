...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            ...
            tonic::Response<super::super::rpc::BlockProducerStatus>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        type MempoolSubscriptionStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::MempoolEvent, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Subscribe to mempool events.
        ...
        async fn mempool_subscription(
            &self,
            request: tonic::Request<super::MempoolSubscriptionRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::MempoolSubscriptionStream>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
            ...
            match req.uri().path() {
                "/block_producer.Api/Status" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<()> for StatusSvc<T> {
                        type Response = super::super::rpc::BlockProducerStatus;
                ...
                "/block_producer.Api/MempoolSubscription" => {
                    #[allow(non_camel_case_types)]
                    struct MempoolSubscriptionSvc<T: Api>(pub Arc<T>);
                    impl<
                        T: Api,
                    > tonic::server::ServerStreamingService<
                        super::MempoolSubscriptionRequest,
                    > for MempoolSubscriptionSvc<T> {
                        type Response = super::MempoolEvent;
                        type ResponseStream = T::MempoolSubscriptionStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Api>::mempool_subscription(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = MempoolSubscriptionSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
